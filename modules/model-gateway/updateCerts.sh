...
CERT_DIR_REST="$BASE_DIR/modules/model-gateway/certs/cert.pem"
CA_CERT_REST="$BASE_DIR/modules/model-gateway/certs/ca.crt"
KEY_REST="$BASE_DIR/modules/model-gateway/certs/key/"
