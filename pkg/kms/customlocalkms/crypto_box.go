...
//   this currently only sits inside CustomLocalKMS so it can access private keys. See issue #511
...
func (l *CustomLocalKMS) exportEncPrivKeyBytes(id string) ([]byte, error) {
