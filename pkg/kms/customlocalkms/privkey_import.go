...
func (l *CustomLocalKMS) importECDSAKey(privKey *ecdsa.PrivateKey, kt kms.KeyType,
...
func (l *CustomLocalKMS) importSecp256K1Key(privKey *ecdsa.PrivateKey, params *secp256k1pb.Secp256K1Params,
	opts ...kms.PrivateKeyOpts) (string, *keyset.Handle, error) {
...
func (l *CustomLocalKMS) buildAndImportECDSAPrivateKeyAsECDHKW(privKey *ecdsa.PrivateKey, kt kms.KeyType,
	opts ...kms.PrivateKeyOpts) (string, *keyset.Handle, error) {
...
func (l *CustomLocalKMS) importKeySet(ks *tinkpb.Keyset, opts ...kms.PrivateKeyOpts) (string, *keyset.Handle, error) {
...
func (l *CustomLocalKMS) importEd25519Key(privKey ed25519.PrivateKey, kt kms.KeyType,
	opts ...kms.PrivateKeyOpts) (string, *keyset.Handle, error) {
	if privKey == nil {
...
func (l *CustomLocalKMS) importBBSKey(privKey *bbs12381g2pub.PrivateKey, kt kms.KeyType,
	opts ...kms.PrivateKeyOpts) (string, *keyset.Handle, error) {
	if privKey == nil {
...
func (l *CustomLocalKMS) importPSMSKey(privKey *psms12381g1pub.PrivateKey, kt kms.KeyType,
	opts ...kms.PrivateKeyOpts) (string, *psms.MockHandle, error) {
	if privKey == nil {
		return "", nil, fmt.Errorf("import private PSMS key failed: private key is nil")
	}
	return l.mockImportKeySet(privKey, kt, opts...)
}

func (l *CustomLocalKMS) mockImportKeySet(key *psms12381g1pub.PrivateKey, kt kms.KeyType, opts ...kms.PrivateKeyOpts) (string, *psms.MockHandle, error) {
	kid, kh, err := l.mockStore.WriteImportedKey(key, kt, opts...)
	if err != nil {
		return "", nil, fmt.Errorf("error importing key to storage %w", err)
	}
...
func (l *CustomLocalKMS) writeImportedKey(ks *tinkpb.Keyset, opts ...kms.PrivateKeyOpts) (string, error) {
