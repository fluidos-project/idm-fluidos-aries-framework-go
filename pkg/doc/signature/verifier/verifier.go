...
type keyResolver interface {
	...
	//XXX UMU Resolves through VDR the key, assumed to be: issuerDID#keyID and key included as a verificationMethod in the didDoc, with raw value (JWK not fully supported)
}
