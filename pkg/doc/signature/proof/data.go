...
func CreateVerifyHash(suite signatureSuite, jsonldDoc, proofOptions map[string]interface{},
	...
	//TODO UMU (issue) Issues (check v0.1.9) with canonicalization of framework implementation:
	// Issue with canonicalization, repeated identifier for blank nodes after appending both elements
	// Issue 2 with canonicalization, json attributes not properly parsed (see testVC in wallet, where "MIT" value for degree is lost)
