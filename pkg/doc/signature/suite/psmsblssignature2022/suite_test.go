...
var (
	...
	vcDoc string
	//go:embed testdata/expected_canonical_doc.jsonld
	expectedCanonicalDoc string
	//go:embed testdata/expected_digest_doc.jsonld
...
func TestSignatureSuite_Accept(t *testing.T) {
	ss := New()
	accepted := ss.Accept("PsmsBlsSignature2022")
