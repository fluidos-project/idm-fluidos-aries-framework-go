...
var DefaultSignatureSuiteSpecs = map[string]SignatureSuiteSpec{ // nolint:gochecknoglobals
	...
	psmsblssignature2022.SignatureType: {
		KeyType:       kms.BLS12381G1Type,
		KeyMultiCodec: fingerprint.BLS12381g1PubKeyMultiCodec,
		Suite: func(opts ...suite.Opt) signer.SignatureSuite {
			return psmsblssignature2022.New(opts...)
		},
		SignatureRepresentation: verifiable.SignatureProofValue,
		Signer: func(p Provider, kh interface{}) Signer {
			return newPSMSSigner(p.KMS(), p.Crypto(), kh)
		},
	},
}
