...
// Verifier is the verification interface primitive for PSMS+ signatures/proofs used by Tink.
type Verifier interface {
	...
	// VerifyProof will verify a PSMS+ signature proof (generated e.g. by Verifier's DeriveProof() call) with the
	// signer's public key.
	// returns:
