...
// TODO UMU (crypto) Add CombineSignatures method. We would need to also create an entry point for that method (wrapper/client), as a new "protocol".
// Crypto interface provides all crypto operations needed in the Aries framework.

//TODO UMU (crypto) Fully integrate PSMS with tink
// TODO UMU (crypto) Add CombineSignatures method. We would need to also create an entry point for that method (wrapper/client), as a new "protocol".
