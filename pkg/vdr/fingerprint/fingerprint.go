...
const (
	...
	// BLS12381psmsg1PubKeyMultiCodec for BLS12-381 G1 public key in multicodec table.
	BLS12381g1PubKeyMultiCodec = 0xea
...
func PubKeyFromDIDKey(didKey string) ([]byte, error) {
	...
	case X25519PubKeyMultiCodec, ED25519PubKeyMultiCodec, BLS12381g2PubKeyMultiCodec, BLS12381g1g2PubKeyMultiCodec,
		P256PubKeyMultiCodec, P384PubKeyMultiCodec, P521PubKeyMultiCodec, BLS12381g1PubKeyMultiCodec:
		break
	default:
