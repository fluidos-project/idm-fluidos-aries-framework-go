...
const (
	...
	didKeyPSMS               = "did:key:"
	pkPSMSBase58             = ""
	keyIDPSMS                = ""
)
...
func TestWallet_Query(t *testing.T) {
	...
	require.NoError(t, walletInstance.Add(tkn, Credential, vcForDerivePsms))
	...
	t.Run("test wallet queries", func(t *testing.T) {
		tests := []struct {
			...
			{
				name: "query by frame PSMS - success",
				params: []*QueryParams{
...
func TestWallet_Issue(t *testing.T) {
	...
	ctc, err := customtinkcrypto.New()
	require.NoError(t, err)

	mockctx := newMockProvider(t)
	mockctx.VDRegistryValue = customVDR
	mockctx.CryptoValue = ctc //TODO UMU (test) Check if we can create Mock Crypto that uses PSMS/BBS automatically in a mock way

	err = CreateProfile(user, mockctx, WithPassphrase(samplePassPhrase))
	require.NoError(t, err)

	user2 := uuid.New().String()
	err = CreateProfile(user2, mockctx, WithPassphrase(samplePassPhrase))
	require.NoError(t, err)
	...
	t.Run("Test VC wallet issue and verify using PSMS - success", func(t *testing.T) {
		walletInstance, err := New(user, mockctx)
		require.NotEmpty(t, walletInstance)
		require.NoError(t, err)
		...
		//testPkB58 := ""// For tests
		//testController := "did:key:" // For tests
		//testKid := "" // For tests
		privKeyPSMS, err := psms12381g1pub.UnmarshalPrivateKey(base58.Decode(pkPSMSBase58))
		require.NoError(t, err)
		//pkb, _ := privKeyPSMS.PublicKey().Marshal() // For tests
		//did, _ := kmsdidkey.BuildDIDKeyByKeyType(pkb, kms.BLS12381G1Type) // For tests
		//fmt.Println(did) // For tests

		// nolint: errcheck, gosec
		_, _, err = kmgr.ImportPrivateKey(privKeyPSMS, kms.BLS12381G1Type, kms.WithKeyID(keyIDPSMS))
		require.NoError(t, err)

		// sign with just controller
		proofRepr := verifiable.SignatureProofValue
		result, err := walletInstance.Issue(authToken, testdata.SampleUDCVCPSMS, &ProofOptions{
			Controller:          didKeyPSMS,
			ProofType:           PsmsBlsSignature2022,
			ProofRepresentation: &proofRepr,
		})
		require.NoError(t, err)
		require.NotEmpty(t, result)
		...
		//Verify
		walletVerifier, err := New(user2, mockctx)
		require.NotEmpty(t, walletVerifier)
		require.NoError(t, err)

		tkn, err := walletVerifier.Open(WithUnlockByPassphrase(samplePassPhrase))
		require.NoError(t, err)
		require.NotEmpty(t, tkn)
		rawBytes, err := result.MarshalJSON()
		require.NoError(t, err)
		//fmt.Println(string(rawBytes)) // For tests
		ok, err := walletVerifier.Verify(tkn, WithRawCredentialToVerify(rawBytes))
		require.NoError(t, err)
		require.True(t, ok)
	})
}
...
func TestWallet_Prove(t *testing.T) {
	...
	// issue a credential with PsmsBlsSignature2022
	proofRepr = verifiable.SignatureProofValue
	result, err = walletForIssue.Issue(issuerToken, testdata.SampleUDCVCPSMS, &ProofOptions{
		Controller:          didKeyPSMS,
		ProofType:           PsmsBlsSignature2022,
		ProofRepresentation: &proofRepr,
	})
	...
	t.Run("Test prove using stored & raw credential - success", func(t *testing.T) {
		...
		psmsVCBytes, err := json.Marshal(vcs["psmsvc"])
		require.NoError(t, err)
		...
		result, err := walletInstance.Prove(authToken,
			...
			WithRawCredentialsToProve(bbsVCBytes, jwtVCBytes, psmsVCBytes),
			WithCredentialsToProve(vcs["edvc"]),
		)
		require.NoError(t, err)
		require.NotEmpty(t, result)
		require.Len(t, result.Proofs, 1)
		require.Len(t, result.Credentials(), 5)
		require.Equal(t, result.Holder, didKey)

		// sign with just controller with all raw credentials
		result, err = walletInstance.Prove(authToken,
			&ProofOptions{Controller: didKey},
			WithRawCredentialsToProve(edVCBytes, bbsVCBytes, psmsVCBytes, jwtVCBytes),
		)
		require.NoError(t, err)
		require.NotEmpty(t, result)
		require.Len(t, result.Proofs, 1)
	...
	t.Run("Test prove using presentation - success", func(t *testing.T) {
		...
		result, err = walletInstance.Prove(authToken,
			...
			WithPresentationToProve(pres),
			WithStoredCredentialsToProve(vcs["edvc"].ID),
			WithRawCredentialsToProve(bbsVCBytes, psmsVCBytes),
		)
	...
	t.Run("Test prove using various proof options - success", func(t *testing.T) {
		...
		cleanup := addCredentialsToWallet(t, walletInstance, authToken, vcs["edvc"], vcs["bbsvc"], vcs["psmsvc"])
		defer cleanup()
		...
		result, err := walletInstance.Prove(authToken, &ProofOptions{
			...
			Created:             &created,
			ProofRepresentation: &proofRepr,
		}, WithStoredCredentialsToProve(vcs["edvc"].ID, vcs["bbsvc"].ID, vcs["psmsvc"].ID))
		require.NoError(t, err)
		require.NotEmpty(t, result)
		require.Len(t, result.Proofs, 1)
...
func TestWallet_Verify(t *testing.T) { //XXX UMU (test) We have already tested verification, but other cases here could be interesting
	user := uuid.New().String()
	customVDR := &mockvdr.MockVDRegistry{
		ResolveFunc: func(didID string, opts ...vdrapi.DIDMethodOption) (*did.DocResolution, error) {
			if didID == sampleInvalidDIDID {
	...
	sampleCrypto, err := customtinkcrypto.New()
	require.NoError(t, err)
...
func TestWallet_Derive(t *testing.T) {
	...
	// import ED25519 & BLS12381G2Type &  BLS12381G1Type keys manually
	session, err := sessionManager().getSession(authToken)
	require.NotEmpty(t, session)
	require.NoError(t, err)
	...
	// issue a credential with PsmsBlsSignature2022
	proofRepr = verifiable.SignatureProofValue
	result, err = walletForIssue.Issue(authToken, testdata.SampleUDCVCPSMS, &ProofOptions{
		Controller:          didKeyPSMS,
		ProofType:           PsmsBlsSignature2022,
		ProofRepresentation: &proofRepr,
	})
	...
	require.NoError(t, json.Unmarshal(testdata.SampleFramePsms, &frameDocPsms))
	...
	t.Run("Test derive a credential from wallet - success - PSMS", func(t *testing.T) {
		walletInstance, err := New(user, mockctx)
		require.NotEmpty(t, walletInstance)
		require.NoError(t, err)
		...
		// save PSMS VC in store
		vcBytes, err := vcs["psmsvc"].MarshalJSON()
		require.NoError(t, err)
		require.NoError(t, walletInstance.Add(tkn, Credential, vcBytes))

		sampleNonce := uuid.New().String()

		verifyPSMSProof := func(proofs []verifiable.Proof) {
			require.Len(t, proofs, 1)
			require.NotEmpty(t, proofs[0])
			require.Equal(t, proofs[0]["type"], "PsmsBlsSignatureProof2022")
			require.NotEmpty(t, proofs[0]["nonce"])
			require.EqualValues(t, proofs[0]["nonce"], base64.StdEncoding.EncodeToString([]byte(sampleNonce)))
			require.NotEmpty(t, proofs[0]["proofValue"])
		}
		...
		// derive stored credential
		vc, err := walletInstance.Derive(tkn, FromStoredCredential(vcs["psmsvc"].ID), &DeriveOptions{
			Nonce: sampleNonce,
			Frame: frameDocPsms,
		})
		require.NoError(t, err)
		require.NotEmpty(t, vc)
		verifyPSMSProof(vc.Proofs)
		...
		// derive from credential instance
		vc, err = walletInstance.Derive(tkn, FromCredential(vcs["psmsvc"]), &DeriveOptions{
			Nonce: sampleNonce,
			Frame: frameDocPsms,
		})
		require.NoError(t, err)
...
func TestWallet_CreateKeyPair(t *testing.T) {
	...
	t.Run("test creating key pair psms", func(t *testing.T) {
		nattr := uint16(7)
		keyPair, err := wallet.CreateKeyPair(token, kms.BLS12381G1Type, kms.WithAttrs([]string{strconv.Itoa(int(nattr))}))
		require.NoError(t, err)
		require.NotEmpty(t, keyPair)
		require.NotEmpty(t, keyPair.KeyID)
		require.NotEmpty(t, keyPair.PublicKey)
		pkb, err := base64.RawURLEncoding.DecodeString(keyPair.PublicKey)
		require.NoError(t, err)
		pk, err := psms12381g1pub.UnmarshalPublicKey(pkb)
		require.NoError(t, err)
		require.Equal(t, pk.Nattrs(), nattr)
	})
}
