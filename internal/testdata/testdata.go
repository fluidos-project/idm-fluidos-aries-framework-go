...
var (
	...
	//go:embed samples/wallet/sample_udc_vc_psms.json
	SampleUDCVCPSMS []byte
	//go:embed samples/wallet/sample_udc_vc_with_credschema_psms.json
	SampleUDCVCWithCredentialSchemaPSMS []byte
	//go:embed samples/wallet/sample_psms_frame.json
